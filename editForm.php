...
$sql = "SELECT * FROM prospStudent WHERE id=$id";
...
<html>
<head>
    <title>Edit Student Form | SMKN 7 Coding</title>
</head>
...
<body>
    ...
    <form action="editProcess.php" method="POST">
        ...
        <p>
            ...
            <input type="text" name="schoolOrigin" placeholder="school name" value="<?php echo $student['schoolOrigin'] ?>" />
        </p>
        <p>
